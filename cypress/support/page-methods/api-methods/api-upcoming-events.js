...
Cypress.Commands.add(
  ...
  (slug, expectedJSON) => {
    cy.request({
      ...
      expect(
        response.body.tickettype_set[0].ticket_items[0].invoice.item_groups[0].quantity_included_in_total
      ).to.eq(
      ...
      expect(
        response.body.tickettype_set[1].ticket_items[0].invoice.item_groups[0].quantity_included_in_total
      ).to.eq(
...
Cypress.Commands.add(
  ...
  (slug, expectedJSON) => {
    cy.request({
      ...
      // Total number of tickets 2
      expect(
        response.body.tickettype_set[0].ticket_items[1].invoice.item_groups[0].quantity_included_in_total
      ).to.eq(
        expectedJSON.purchased_tickets.tickettype_set[0].ticket_items[1].invoice
          .item_groups[0].quantity_included_in_total
      );
      // Ticket type 3
      expect(response.body.tickettype_set[1].name).to.eq(
      ...
      expect(
        response.body.tickettype_set[0].ticket_items[2].invoice.item_groups[0].quantity_included_in_total
      ).to.eq(
        expectedJSON.purchased_tickets.tickettype_set[0].ticket_items[2].invoice
          .item_groups[0].quantity_included_in_total
      );
    });
  }
